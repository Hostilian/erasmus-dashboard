...
porto_paras = [
    "I am writing to formally express my strong interest in participating in the Erasmus+ exchange program at Universidade Portucalense (UPT) in Porto, Portugal, for the Fall semester of the 2026/2027 academic year. As a BSc Informatics student at the Czech University of Life Sciences Prague (CZU) who also works professionally as a software developer and data analyst, I am eager to combine my practical industry experience with UPT's outstanding academic offerings under the bilateral agreements for both Information and Communication Technologies (ICTs - 061) and Business and Administration (041).",
    "UPT Porto is my top-choice host institution because its course catalog allows for cross-departmental selection, which aligns perfectly with my double-focus on software systems and business informatics. I have mapped six core and elective subjects that serve as direct equivalents to my remaining CZU degree requirements: EIE69E UNIX Operating Systems (equivalent to Sistemas Operativos - 6 ECTS), ETE3AE Web Design (equivalent to Tecnologias Web - 6 ECTS), ESE48E Statistics (equivalent to Estatística e Análise de Dados - 6 ECTS), EIE96E Fundamentals of Accounting (equivalent to Contabilidade Geral - 6 ECTS), EEEI2E Business Economics (equivalent to Economia da Empresa - 6 ECTS), and EIE96E Interaction Design (equivalent to Conceção de Interfaces - 6 ECTS). Studying these in UPT's English-supported academic environment will allow me to maintain my graduation timeline while deepening my professional skill set.",
    "Beyond academics, Porto is a fantastic cultural and personal fit. Having lived and worked in Prague as a Turkish national, I am highly independent and experienced in managing international relocations under Directive 2016/801 student mobility frameworks. I will be relocating with my pet cat, Turuncu (Çu), which requires responsible veterinary preparation (including ISO microchipping, rabies vaccination, and EU Pet Passport coordination). In my free time, I look forward to engaging with Porto's active student community, participating in ESN activities, and training at local climbing facilities like São Rock Climbing and Proa Climbing Center.",
    "I am confident that my software engineering background, academic diligence, and adaptability will make me a strong addition to UPT Porto and a proud representative of CZU Prague. Thank you for considering my application. I look forward to the possibility of studying at Universidade Portucalense."
]
